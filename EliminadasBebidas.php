...
<a href="#" class="active">Menu Administrador</a>
        ...
        <a href="EliminadasBebidas.php"  style='background-color:#81D5D0; color:#000; text-align:center; letter-spacing:2px;'>Bebidas Eliminadas</a>
    ...
    <table style="background: #81D5D0; border: 2px solid gray;">
        <tr>
            ...
            <td>
                ...
                <form action="EliminadasBebidas.php" method="POST">
                    <table align="center" width="100" class="responsive-table">
                        ...
                        for ($i = 0; $i < count($lista); $i++) {
                            ...
                            echo "<td> <a href='EliminadasBebidas.php?cod_eli=" . $b->getCodigoBeb() . "' style='color: #FE3E3E' onclick='return ConfirmDelete()'>Activar Bebida</a></td>";
                            echo "</tr>";
                        }
                        ?>
                    </table>
