...
<div class="vertical-menu" style="float: right;" >
  ...
  <a href="EliminadosAguas.php" style='background-color:#81D5D0; color:#000; text-align:center; letter-spacing:2px;'>Aguas Eliminadas</a>
    ...
    <table style="background: #81D5D0; border: 2px solid gray;">
        <tr>
            ...
            <td>
                ...
                <form action="EliminadosAguas.php" method="POST">
                    <table align="center" width="100" class="responsive-table">
                        ...
                        <?php
                        $lista = $d->ListarAguasEliminadas();
                        for ($i = 0; $i < count($lista); $i++) {
                            $b = $lista[$i];
                            echo "<tr>";
                            echo "<td>" . $b->getCodigoAgu() . "</td>";
                            echo "<td>" . $b->getNombreAgu() . "</td>";
                            echo "<td>" . $b->getPrecioAgu() . "</td>";
                            echo "<td>" . $b->getEstadoAgu() . "</td>";
                            echo "<td> <a href='EliminadosAguas.php?cod_eli=" . $b->getCodigoAgu() . "' style='color: #FE3E3E' onclick='return ConfirmDelete()'>Activar Agua</a></td>";
                            echo "</tr>";
                        }
                        ?>
                    </table>
