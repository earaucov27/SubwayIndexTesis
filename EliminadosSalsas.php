...
;'>
        ...
        <div class="vertical-menu" style="float: right;" >
          ...
          <a href="EliminadosSalsas.php" style='background-color:#81D5D0; color:#000; text-align:center; letter-spacing:2px;'>Salsas Eliminadas</a>
    ...
    <table style="background: #81D5D0; border: 2px solid gray;">
        <tr>
            ...
            <td>
                ...
                <form action="EliminadosSalsas.php" method="POST">
                    <table align="center" width="100" class="responsive-table">
                        ...
                        <?php
                        $lista = $d->ListarSalsasEliminadas();
                        for ($i = 0; $i < count($lista); $i++) {
                            ...
                            echo "<td> <a href='EliminadosSalsas.php?cod_eli=" . $s->getCodigoSal() . "' style='color: #FE3E3E' onclick='return ConfirmDelete()'>Activar Salsa</a></td>";
                            echo "</tr>";
                        }
                        ?>
                    </table>
