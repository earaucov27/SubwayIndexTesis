...
<body style="width: 90%; margin: auto; background: url(imagenes/fondoadmin.jpg);">
  ...
  <p style="background: white; padding: 10px; width: 200px;">Bienvenido
    <strong>
  ...
  <center>
    <div class="vertical-menu" style="float: left;">
      ...
      <a href="GestionUsuarios1.php" style='background-color:#81D5D0; color:#000; text-align:center; letter-spacing:2px;'>Gestion de usuarios</a>
    ...
    <tr>
      ...
      <td>
        ...
        <table align="center" width="100" class="responsive-table">
          ...
          <?php
          $lista = $d->ListarUsuarios();
          for ($i = 0; $i < count($lista); $i++) {
            $u = $lista[$i];
            echo "<tr>";
            echo "<td>" . $u->getCodigousuario() . "</td>";
            echo "<td>" . $u->getEmail() . "</td>";
            echo "<td>" . $u->getNombre() . "</td>";
            echo "<td>" . $u->getApellido() . "</td>";
            echo "<td>" . $u->getDireccion() . "</td>";
            echo "<td>" . $u->getRespuesta() . "</td>";
            echo "<td> <a href='GestionUsuarios1.php?cod_eli=" . $u->getCodigousuario() . "' style='color: #FE3E3E'  onclick='return ConfirmDelete()'>Eliminar Usuario</a></td>";
            echo "</tr>";
          }
          ?>
        </table>
