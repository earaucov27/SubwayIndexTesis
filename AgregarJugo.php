...
<p style="background: white; padding: 10px; width: 200px;">Bienvenido <strong>
  <?php echo $_SESSION["Administrador"];?>
	...
	<div class="vertical-menu" style="float: center;">
			...
			<a href="AgregarJugo.php" style='background-color:#81D5D0; color:#000; text-align:center; letter-spacing:2px;'>Agregar Jugo</a>
	...
	<table style="background: #81D5D0; border: 2px solid gray;">
		<tr>
			...
			<td>
				...
				<form action="AgregarJugo.php" method="POST">
					<table align="center" width="100" class="responsive-table">
						<caption>Jugo</caption>
						<tr>
							<td>Codigo de Jugo</td>
							<td>
								<input type="number" name="txt_codJug"style="background: white;" placeholder="Digite el codigo de jugo nuevo" required maxlength="4" min="1">
							</td>
						</tr>
						<tr>
							<td>Nombre de Jugo</td>
							<td>
								<input type="text" name="txt_nomjug" style="background: white;"placeholder="Escriba el nombre del Jugo nuevo" required>
							</td>
						</tr>
						<tr>
							<td>Precio de Jugo</td>
							<td>
								<input type="text" name="txt_preJug"style="background: white;" placeholder="Digite el precio del Jugo nuevo" required>
							</td>
						</tr>
						<tr>
						<tr hidden>
							<td>Estado Jugo</td>
							<td>
								<input type="text" name="txt_estJug" style="background: white;"placeholder="Digite el precio del Jugo nuevo" required value='Activo'>
							</td>
						</tr>
						<tr>
							<td>
								<input type="submit" name="btn_agregarJugo" onclick="return ConfirmAdd()" value="Agregar Jugo" style="color:black; text-transform:uppercase; background: #35DD1F; padding: 10px; border: 1px solid gray; cursor: pointer;">
							</td>
							<td>
								<input type="submit" name="btn_modificarJugo" onclick="return ConfirmMod()" value="Actualizar Datos" style="color:black; text-transform:uppercase; background: #FFF441; padding: 10px; border: 1px solid gray; cursor: pointer;">
								<string>*Para actualizar el Jugo se necesita indicar el CODIGO del JUGO*</string>
							</td>
						</tr>
					</table>
				</form>
				...
				<table align="center" width="100" class="responsive-table">
					<caption>Jugos Registradas</caption>
					<tr>
						<td>Codigo</td>
						<td>Nombre</td>
						<td>Precio</td>
					...
					for ($i = 0; $i < count($lista); $i++) {
						...
						echo "<td> <a href='AgregarJugo.php?cod_eli=" . $j->getCodigoJug() . "' style='color: #FE3E3E' onclick='return ConfirmDelete()'>Eliminar Jugo</a></td>";
						echo "</tr>";
					}
					?>
			</td>
